...
c.execute('CREATE TABLE IF NOT EXISTS preco_compra (Currency text, preco_compra float, market_date timestamp DEFAULT CURRENT_TIMESTAMP)')
conn.commit()

c.execute('CREATE TABLE IF NOT EXISTS preco_venda (Currency text, preco_venda float, market_date timestamp DEFAULT CURRENT_TIMESTAMP)')
conn.commit()

c.execute('CREATE TABLE IF NOT EXISTS rentabilidade (Currency text, rentabilidade float, market_date timestamp DEFAULT CURRENT_TIMESTAMP)')
conn.commit()
